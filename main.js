...
const PACKAGES = {
  ...
  pos_F: { id:'pos_F', cat:'troja', letter:'F', name:'Bröst', desc:'Den mest synliga ytan på tröjan — högt upp på bröstet, över klubbloggan.', price:15000, status:'taken', takenBy:'Sejfa', until:'våren 2028', reach:600000 },
  ...
  pos_Panna: { id:'pos_Panna', cat:'hjalm', letter:'I', name:'Hjälm panna', desc:'Placering mitt på hjälmens panna. Mycket synlig i närbilder, lagfoton och videointervjuer.', price:10000, status:'taken', takenBy:'SUHL', until:'våren 2027', reach:400000 },
  pos_Sida: { id:'pos_Sida', cat:'hjalm', letter:'J', name:'Hjälm sida', desc:'Placering på hjälmens sida. Syns bra från profilen vid spel och i rinken.', price:8000, status:'taken', takenBy:'Horda Stans AB', until:'våren 2027', reach:300000 },
